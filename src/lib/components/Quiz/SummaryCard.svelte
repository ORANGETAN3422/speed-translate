...
<div class="flex flex-1 flex-col gap-1">
	...
	<p class="text-sm">
		...
		<span
			class="group-hover/card:text-text transition-all duration-300 group-hover/card:[text-shadow:0_0_8px_var(--primary)]"
...
>
	<div
		class="bg-fancy-deep absolute inset-0 -z-10 opacity-60"
		style="clip-path: polygon(40px 0, 100% 0, 100% 100%, 0 100%);"
	></div>

	<div
		class="bg-fancy-deep absolute inset-0 -z-10 opacity-60 transition-opacity duration-300 group-hover/card:opacity-100"
		style="clip-path: polygon(50px 0, 100% 0, 100% 100%, 0 100%);"
	></div>
